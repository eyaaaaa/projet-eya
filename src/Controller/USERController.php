...
class USERController extends AbstractController
{
    ...
    public function  signupAction(Request  $request, UserPasswordEncoderInterface $passwordEncoder) {
        ...
        $emailadresse = $request->query->get("emailadresse");
        ...
        $user->setsetEmailadresse($emailadresse);
        ...
        $user->setRole($role);//aleh array khater roles par defaut fi security  type ta3ha array
    ...
    public function editUser(Request $request, UserPasswordEncoderInterface $passwordEncoder) {
        ...
        if($request->files->get("images")!= null) {
            ...
            $file = $request->files->get("images");//njib image fi url
        ...
        $user->setEmailadresse($emailadresse);
        $user->setIsVerified(true);//par défaut user lazm ykoun enabled.
